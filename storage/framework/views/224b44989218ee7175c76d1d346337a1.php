<?php $__env->startSection('title', 'M3 Mobile Care - Premium Accessories & Gadgets Shop'); ?>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide ul-banner-slide">
                            <div class="ul-banner-slide-img">
                                <img src="<?php echo e(asset('frontend/img/banner-slide-1.jpg')); ?>" alt="Banner Image">
                            </div>
                            <div class="ul-banner-slide-txt">
                                ...
                                <a href="<?php echo e(route('shop.catalog')); ?>" class="ul-btn">SHOP NOW <i class="flaticon-up-right-arrow"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide ul-banner-slide ul-banner-slide--2">
                            <div class="ul-banner-slide-img">
                                <img src="<?php echo e(asset('frontend/img/banner-slide-2.jpg')); ?>" alt="Banner Image">
                            </div>
                            <div class="ul-banner-slide-txt">
                        ...
                        <div class="swiper-slide ul-banner-slide ul-banner-slide--3">
                            <div class="ul-banner-slide-img">
                                <img src="<?php echo e(asset('frontend/img/banner-slide-3.jpg')); ?>" alt="Banner Image">
                            </div>
                            <div class="ul-banner-slide-txt">
                ...
                <div class="ul-banner-img-slider swiper">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="<?php echo e(asset('frontend/img/banner-img-slide-1.jpg')); ?>" alt="Banner Image">
                        </div>
                        <div class="swiper-slide">
                            <img src="<?php echo e(asset('frontend/img/banner-img-slide-2.jpg')); ?>" alt="Banner Image">
                        </div>
                        <div class="swiper-slide">
                            <img src="<?php echo e(asset('frontend/img/banner-img-slide-3.jpg')); ?>" alt="Banner Image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="ul-categories">
        <div class="ul-inner-container">
            <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 row-cols-xxs-1 ul-bs-row">
                <!-- single category -->
                <div class="col">
                    <a class="ul-category" href="<?php echo e(route('shop.catalog')); ?>">
                        <div class="ul-category-img">
                            <img src="<?php echo e(asset('frontend/img/category-1.jpg')); ?>" alt="Chargers">
                        </div>
                ...
                <div class="col">
                    <a class="ul-category" href="<?php echo e(route('shop.catalog')); ?>">
                        <div class="ul-category-img">
                            <img src="<?php echo e(asset('frontend/img/category-2.jpg')); ?>" alt="Covers">
                        </div>
                        <div class="ul-category-txt">
                ...
                <div class="col">
                    <a class="ul-category" href="<?php echo e(route('shop.catalog')); ?>">
                        <div class="ul-category-img">
                            <img src="<?php echo e(asset('frontend/img/category-3.jpg')); ?>" alt="Glass Protectors">
                        </div>
                        <div class="ul-category-txt">
                ...
                <div class="col">
                    <a class="ul-category" href="<?php echo e(route('shop.catalog')); ?>">
                        <div class="ul-category-img">
                            <img src="<?php echo e(asset('frontend/img/category-4.jpg')); ?>" alt="Earphones">
                        </div>
                        <div class="ul-category-txt">
    ...
    <section class="ul-products">
        <div class="ul-inner-container">
            <div class="ul-section-heading">
                ...
                <div class="right"><a href="<?php echo e(route('shop.catalog')); ?>" class="ul-btn">More Collection <i class="flaticon-up-right-arrow"></i></a></div>
            </div>
                ...
                <div class="col-lg-3 col-md-4 col-12">
                    <div class="ul-products-sub-banner">
                        <div class="ul-products-sub-banner-img">
                            <img src="<?php echo e(asset('frontend/img/products-sub-banner-1.jpg')); ?>" alt="Sub Banner Image">
                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="ul-product">
                                        ...
                                        <div class="ul-product-txt">
                                            ...
                                            <h5 class="ul-product-category"><a href="<?php echo e(route('shop.catalog')); ?>"><?php echo e($item->categoryRelation->name ?? $item->category ?? 'Accessory'); ?></a></h5>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="ul-ad">
        <div class="ul-inner-container">
            <div class="ul-ad-content">
                ...
                <div class="ul-ad-img">
                    <img src="<?php echo e(asset('frontend/img/ad-img.png')); ?>" alt="Ad Image">
                </div>

                <a href="<?php echo e(route('shop.catalog')); ?>" class="ul-btn">Check Discount <i class="flaticon-up-right-arrow"></i></a>
            </div>
        </div>
    </section>
</div>
    ...
    <section class="ul-products ul-most-selling-products">
        <div class="ul-inner-container">
            ...
            <div class="ul-bs-row row row-cols-xl-4 row-cols-lg-3 row-cols-sm-2 row-cols-1 ul-filter-products-wrapper">
                <?php $__currentLoopData = $accessories->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\m3-mobile-care\resources\views/frontend/index.blade.php ENDPATH**/ ?>