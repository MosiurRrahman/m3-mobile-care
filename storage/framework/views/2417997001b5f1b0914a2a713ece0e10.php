...
<?php $__env->startSection('title', 'Staff Login - M3 Mobile Care'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="text-center mb-4">
                    <a href="<?php echo e(route('home')); ?>" class="d-block mb-3 text-decoration-none">
                        <img src="<?php echo e(asset('assets/img/branding/logo-light-icon.png')); ?>" alt="M3 Mobile Care Logo" style="height: 60px; width: auto; object-fit: contain;">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('login.post')); ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" id="email" class="form-control" placeholder="admin@m3mobile.com" value="<?php echo e(old('email')); ?>" required autofocus autocomplete="username">
                            </div>
                            <div class="mb-3">
                            ...
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-secondary w-100 py-2.5"><i class="ti tabler-arrow-left me-2"></i>Back to Homepage</a>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layouts/blankLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\m3-mobile-care\resources\views/auth/login.blade.php ENDPATH**/ ?>