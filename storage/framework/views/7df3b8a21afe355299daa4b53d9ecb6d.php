    ...
    <div class="ul-sidebar-header">
        <div class="ul-sidebar-header-logo">
            <a href="<?php echo e(route('home')); ?>" class="d-inline-flex align-items-center text-decoration-none">
                <img src="<?php echo e(asset('assets/img/branding/logo-light-icon.png')); ?>" alt="logo" class="logo" style="max-height: 40px; width: auto; object-fit: contain;">
            ...
            <div class="ul-header-bottom-wrapper">
                ...
                <div class="header-bottom-left">
                    ...
                    <div class="ul-header-search-form-wrapper flex-grow-1 flex-shrink-0">
                        <form action="<?php echo e(route('shop.catalog')); ?>" method="GET" class="ul-header-search-form">
                            <div class="ul-header-search-form-right border-0 w-100">
                                <input type="search" name="search" id="ul-header-search" placeholder="Search Accessories (Charger, Cover, Glass...)" value="<?php echo e(request('search')); ?>">
                ...
                <div class="ul-header-nav-wrapper">
                    <div class="to-go-to-sidebar-in-mobile">
                        <nav class="ul-header-nav">
                            ...
                            <a href="<?php echo e(route('shop.catalog')); ?>" class="<?php echo e(request()->routeIs('shop.catalog') ? 'active' : ''); ?>">Shop</a>
                            
                            <div class="has-sub-menu">
                                <a role="button">Pages</a>
                                <div class="ul-header-submenu">
                                    <ul>
                                        <li><a href="<?php echo e(route('shop.about')); ?>">About Us</a></li>
                                        <li><a href="<?php echo e(route('shop.faq')); ?>">FAQ</a></li>
                                        <li><a href="<?php echo e(route('shop.contact')); ?>">Contact</a></li>
                                        <li><a href="<?php echo e(route('customer.login')); ?>">Customer Login</a></li>
                                        <li><a href="<?php echo e(route('customer.register')); ?>">Customer Sign Up</a></li>
                                    </ul>
                                </div>
                            </div>

                            <a href="<?php echo e(route('shop.about')); ?>">About</a>
                    ...
                    <?php if(auth()->check()): ?>
                        <div class="dropdown d-inline-block">
                            <a href="#" class="dropdown-toggle text-dark text-decoration-none fw-bold" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="flaticon-user me-1" style="color: var(--ul-primary);"></i> <?php echo e(\Illuminate\Support\Str::words(auth()->user()->name, 1, '')); ?>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 mt-2">
                                ...
                                <?php if(auth()->user()->isAdmin() || auth()->user()->isSuperAdmin() || auth()->user()->role === 'salesman'): ?>
                                    <li><a class="dropdown-item py-2" href="<?php echo e(route('dashboard')); ?>"><i class="flaticon-home me-2"></i>Admin Dashboard</a></li>
                                <?php endif; ?>
                                <li><a class="dropdown-item py-2 text-danger" href="<?php echo e(route('customer.logout')); ?>"><i class="flaticon-close me-2"></i>Logout</a></li>
                            </ul>
                        </div>
                    <?php else: ?>
                        <a href="<?php echo e(route('customer.login')); ?>" title="Login / Register"><i class="flaticon-user"></i></a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('shop.wishlist')); ?>" class="position-relative">
                        <i class="flaticon-heart"></i>
                        <?php if($wishlistCount > 0): ?>
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.65rem; padding: 0.25em 0.4em;"><?php echo e($wishlistCount); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('shop.cart')); ?>" class="position-relative">
                        <i class="flaticon-shopping-bag"></i>
                        <?php if($cartCount > 0): ?>
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.65rem; padding: 0.25em 0.4em;"><?php echo e($cartCount); ?></span>
                        <?php endif; ?>
                    </a>
                </div>
...
<!-- HEADER SECTION END -->
<?php /**PATH E:\laragon\www\m3-mobile-care\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>