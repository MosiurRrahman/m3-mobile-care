...
<?php $__env->startSection('title', 'Expense Manager - M3 Mobile Care'); ?>
...
<div class="row">
    ...
    <div class="col-12 mb-4">
        <div class="row row-cols-1 row-cols-md-5 g-3">
            ...
            ?>
            <div class="col">
                <div class="card border-0 shadow-sm bg-label-<?php echo e($color); ?> h-100">
                    <div class="card-body text-center p-3">
                        <span class="fw-semibold text-muted d-block small mb-1"><?php echo e($cat); ?></span>
                        <h4 class="fw-extrabold text-<?php echo e($color); ?> mb-0"><?php echo e(number_format($sums[$cat] ?? 0, 0)); ?> BDT</h4>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center pb-2">
                ...
                <span class="fw-bold text-danger">Total Outflow: <?php echo e(number_format($totalExpenses, 2)); ?> BDT</span>
            </div>

            <!-- Filter & Search Section -->
            <div class="card-body bg-light border-top border-bottom py-3">
                <form action="<?php echo e(route('admin.expenses.index')); ?>" method="GET" class="row g-2 align-items-center">
                    <div class="col-md-3">
                        <input type="text" name="search" class="form-control form-control-sm" placeholder="Search description..." value="<?php echo e(request('search')); ?>">
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('admin.expenses.index')); ?>" class="btn btn-sm btn-outline-secondary w-100">Reset</a>
                    </div>
                </form>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><span class="badge <?php echo e($color); ?> fs-6"><?php echo e($expense->category); ?></span></td>
                            <td><span class="text-dark"><?php echo e($expense->description ?? 'N/A'); ?></span></td>
                            <td><span class="fw-bold text-danger"><?php echo e(number_format($expense->amount, 2)); ?> BDT</span></td>
                            <td><?php echo e(\Carbon\Carbon::parse($expense->expense_date)->format('M d, Y')); ?></td>
                            <td class="text-end">
                                <div class="d-inline-flex">
                                    <button class="btn btn-icon btn-sm btn-outline-primary me-1 edit-expense-btn" 
                                            ...
                                            data-expense_date="<?php echo e($expense->expense_date); ?>"
                                    ...
                                    <form action="<?php echo e(route('admin.expenses.destroy', $expense->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this expense record?');">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="date" name="expense_date" id="add_expense_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
                        </div>
                    </div>
                    <div class="mb-0">
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\m3-mobile-care\resources\views/expenses/index.blade.php ENDPATH**/ ?>