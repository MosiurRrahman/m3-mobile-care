<?php $__env->startSection('title', 'Customer Profile - M3 Mobile Care'); ?>
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>" class="text-muted text-decoration-none">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('admin.customers.index')); ?>" class="text-muted text-decoration-none">Customers</a></li>
                    <li class="breadcrumb-item active text-primary" aria-current="page"><?php echo e($customer->name); ?></li>
                </ol>
            </nav>
        </div>
        <a href="<?php echo e(route('admin.customers.index')); ?>" class="btn btn-outline-secondary px-3 rounded-pill">
                    ...
                    <div class="col-md-3 text-center text-md-start border-end-md pb-3 pb-md-0">
                        <div class="d-flex flex-column flex-md-row align-items-center gap-3">
                            ...
                            <div class="text-center text-md-start">
                                <h5 class="fw-bold text-dark mb-1"><?php echo e($customer->name); ?></h5>
                    ...
                    <div class="col-md-5 border-end-md pb-3 pb-md-0">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <a href="tel:<?php echo e($customer->phone); ?>" class="fw-bold text-dark text-decoration-none"><?php echo e($customer->phone); ?></a>
                            </div>
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <div class="p-2.5 rounded bg-label-success text-center border-xs-success" style="border: 1px solid rgba(46, 204, 113, 0.1) !important;">
                                    ...
                                    <h5 class="fw-bold text-success mb-0"><?php echo e(number_format($totalSpent, 2)); ?> ৳</h5>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="p-2.5 rounded bg-label-danger text-center border-xs-danger" style="border: 1px solid rgba(231, 76, 60, 0.1) !important;">
                                    ...
                                    <h5 class="fw-bold text-danger mb-0"><?php echo e(number_format($totalDue, 2)); ?> ৳</h5>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="p-2 rounded bg-label-info d-flex align-items-center justify-content-between border-xs-info" style="border: 1px solid rgba(52, 152, 219, 0.1) !important;">
                                    ...
                                    <span class="badge bg-info rounded-pill px-2.5 py-1 text-white fw-bold" style="background-color: #3498db !important;"><?php echo e($activeRepairsCount); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-12 mb-4">
        <div class="card border-0 shadow-sm" style="border: 1px solid rgba(231, 76, 60, 0.25) !important; background-color: rgba(231, 76, 60, 0.02) !important;">
            <div class="card-header bg-transparent border-0 pb-1 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <span class="badge bg-danger rounded-pill fw-bold px-3 py-1"><?php echo e($unpaidRepairs->count() + $unpaidSales->count()); ?> Bill(s) Unpaid</span>
            </div>
            <div class="card-body pt-2">
                <div class="table-responsive text-nowrap bg-white rounded border">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $unpaidSales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="ps-3"><span class="fw-bold text-dark"><?php echo e($sale->invoice_no); ?></span></td>
                                    ...
                                    <div class="d-flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $sale->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge bg-light text-dark border rounded px-2 py-0.5 small" style="font-size: 0.75rem;">
                                                <?php echo e($detail->item ? $detail->item->name : 'Deleted product'); ?> (x<?php echo e($detail->quantity); ?>)
                                            </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </td>
                                <td><span class="fw-bold text-danger"><?php echo e(number_format($sale->due_amount, 2)); ?> ৳</span></td>
                                <td class="text-end pe-3">
                                    <button type="button" class="btn btn-sm btn-success pay-due-btn px-3 py-1 rounded" data-id="<?php echo e($sale->id); ?>" data-invoice="<?php echo e($sale->invoice_no); ?>" data-due="<?php echo e($sale->due_amount); ?>" data-type="sale" data-bs-toggle="modal" data-bs-target="#payDueModal">
                            ...
                            <?php $__currentLoopData = $unpaidRepairs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $repair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="ps-3"><a href="<?php echo e(route('admin.repairs.show', $repair->id)); ?>" class="fw-bold text-primary text-decoration-none"><?php echo e($repair->ticket_id); ?></a></td>
                                <td><span class="badge bg-label-info rounded-pill">Device Repair</span></td>
                                <td>
                                    <span class="fw-bold text-dark d-block"><?php echo e($repair->device_brand); ?> <?php echo e($repair->device_model); ?></span>
                                    <span class="text-muted small">Issue: <?php echo e(Str::limit($repair->issue_description, 50)); ?></span>
                                </td>
                                <td><span class="fw-bold text-danger"><?php echo e(number_format($repair->due_amount, 2)); ?> ৳</span></td>
                                <td class="text-end pe-3">
                                    <button type="button" class="btn btn-sm btn-warning pay-due-btn px-3 py-1 rounded text-dark" data-id="<?php echo e($repair->id); ?>" data-invoice="<?php echo e($repair->ticket_id); ?>" data-due="<?php echo e($repair->due_amount); ?>" data-type="repair" data-bs-toggle="modal" data-bs-target="#payDueModal">
                                        <i class="ti tabler-cash me-1 fs-6"></i>Pay Due
                                    </button>
                                </td>
                            </tr>
                ...
                <ul class="nav nav-pills mb-3" id="profileTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active fw-bold px-4 py-2" id="repairs-tab" data-bs-toggle="tab" data-bs-target="#repairs-content" type="button" role="tab" aria-controls="repairs-content" aria-selected="true">
                            <i class="ti tabler-device-mobile-cog me-1.5 fs-5"></i>Repair History (<?php echo e(count($repairs)); ?>)
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold px-4 py-2" id="sales-tab" data-bs-toggle="tab" data-bs-target="#sales-content" type="button" role="tab" aria-controls="sales-content" aria-selected="false">
                            <i class="ti tabler-receipt me-1.5 fs-5"></i>POS Purchase History (<?php echo e(count($sales)); ?>)
                        </button>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover text-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <a href="<?php echo e(route('admin.repairs.show', $repair->id)); ?>" class="fw-bold text-primary text-decoration-none"><?php echo e($repair->ticket_id); ?></a>
                                    </td>
                                    <td>
                                        <span class="fw-bold text-dark d-block mb-0.5"><?php echo e($repair->device_brand); ?></span>
                                        <span class="text-muted small"><?php echo e($repair->device_model); ?></span>
                                    </td>
                                    <td>
                                        <?php
                                            $badges = [
                                        ...
                                        ?>
                                        <span class="badge <?php echo e($badges[$repair->status] ?? 'bg-label-secondary'); ?> px-2.5 py-1 rounded">
                                            <?php echo e(ucfirst(str_replace('_', ' ', $repair->status))); ?>
                                    ...
                                    <td>
                                        <div class="small">
                                            <?php if($repair->actual_cost !== null): ?>
                                                <div class="text-dark">Bill: <span class="fw-bold"><?php echo e(number_format($repair->actual_cost, 2)); ?> ৳</span></div>
                                                <div class="text-success">Paid: <span class="fw-bold"><?php echo e(number_format($repair->paid_amount, 2)); ?> ৳</span></div>
                                                <?php if($repair->due_amount > 0): ?>
                                                    <div class="text-danger mt-0.5">Due: <span class="fw-bold px-1.5 py-0.5 bg-light-danger rounded text-danger" style="font-size: 0.75rem;"><?php echo e(number_format($repair->due_amount, 2)); ?> ৳</span></div>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                <div class="text-muted">Est: <?php echo e(number_format($repair->estimated_cost, 2)); ?> ৳</div>
                                                <?php if($repair->advance_payment > 0): ?>
                                                    <div class="text-info">Adv: <?php echo e(number_format($repair->advance_payment, 2)); ?> ৳</div>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </div>
                                    </td>
                                    <td>
                                        <?php if($repair->status === 'delivered'): ?>
                                            ...
                                            ?>
                                            <?php if($isWarrantyValid): ?>
                                                <span class="badge bg-label-success rounded-pill" title="Expires <?php echo e($warrantyExpires->format('M d, Y')); ?>">
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-inline-flex gap-1.5 align-items-center">
                                            <?php if($repair->due_amount > 0): ?>
                                                <button type="button" class="btn btn-sm btn-warning pay-due-btn px-2.5 py-1 rounded text-dark" data-id="<?php echo e($repair->id); ?>" data-invoice="<?php echo e($repair->ticket_id); ?>" data-due="<?php echo e($repair->due_amount); ?>" data-type="repair" data-bs-toggle="modal" data-bs-target="#payDueModal" title="Pay Due Balance">
                                                    <i class="ti tabler-cash me-1 fs-6"></i>Pay Due
                                                </button>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('admin.repairs.show', $repair->id)); ?>" class="btn btn-icon btn-sm btn-outline-info rounded" title="View Ticket Details"><i class="ti tabler-eye"></i></a>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover text-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <span class="fw-bold text-dark"><?php echo e($sale->invoice_no); ?></span>
                                    </td>
                                    <td class="text-wrap" style="max-width: 300px;">
                                        <div class="d-flex flex-wrap gap-1">
                                            <?php $__currentLoopData = $sale->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <td><span class="fw-bold text-dark"><?php echo e(number_format($sale->payable_amount, 2)); ?> ৳</span></td>
                                    <td><span class="fw-bold text-success"><?php echo e(number_format($sale->paid_amount, 2)); ?> ৳</span></td>
                                    <td>
                                        <?php if($sale->due_amount > 0): ?>
                                            <span class="badge bg-label-danger fw-bold"><?php echo e(number_format($sale->due_amount, 2)); ?> ৳</span>
                                        <?php else: ?>
                                            <span class="text-muted small">0.00 ৳</span>
                                        <?php endif; ?>
                                    </td>
                                    <td><span class="badge bg-label-primary px-2.5 py-1 rounded"><?php echo e($sale->payment_method); ?></span></td>
                                    <td><span class="small text-muted"><?php echo e($sale->created_at->format('M d, Y')); ?></span></td>
                                    <td class="text-end pe-4">
                                        <div class="d-inline-flex gap-1.5 align-items-center">
                                            <?php if($sale->due_amount > 0): ?>
                                                <button type="button" class="btn btn-sm btn-success pay-due-btn px-2.5 py-1 rounded" data-id="<?php echo e($sale->id); ?>" data-invoice="<?php echo e($sale->invoice_no); ?>" data-due="<?php echo e($sale->due_amount); ?>" data-type="sale" data-bs-toggle="modal" data-bs-target="#payDueModal" title="Pay Due Balance">
                                                    <i class="ti tabler-cash me-1 fs-6"></i>Pay Due
                                                </button>
                                            <?php endif; ?>
                                            <a href="<?php echo e(route('admin.pos.invoice', $sale->id)); ?>" target="_blank" class="btn btn-icon btn-sm btn-outline-info rounded" title="Invoice Print"><i class="ti tabler-printer"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\m3-mobile-care\resources\views/customers/show.blade.php ENDPATH**/ ?>