...
<?php $__env->startSection('title', 'Accessories Stock - M3 Mobile Care'); ?>
...
<div class="row">
    ...
    <div class="col-12 mb-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <a href="<?php echo e(route('admin.inventory.create', ['type' => 'accessory'])); ?>" class="btn btn-primary">
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-0 py-3">
                <form action="<?php echo e(route('admin.inventory.accessories')); ?>" method="GET" class="row g-2 align-items-center">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2 d-flex gap-1.5">
                        ...
                        <a href="<?php echo e(route('admin.inventory.accessories')); ?>" class="btn btn-sm btn-outline-secondary w-100">Reset</a>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\m3-mobile-care\resources\views/inventory/accessories.blade.php ENDPATH**/ ?>