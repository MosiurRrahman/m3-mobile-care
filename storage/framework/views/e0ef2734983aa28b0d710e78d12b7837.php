<?php $__env->startSection('title', ($shopSettings['shop_name'] ?? 'M3 Mobile Care') . ' - E-Commerce Store & Smartphone Service Center'); ?>
<?php $__env->startSection('meta_description', ($shopSettings['shop_name'] ?? 'M3 Mobile Care') . ' - ' . ($shopSettings['shop_slogan'] ?? 'Premium Mobile Repair & Retail') . '. Shop trending mobile parts, original display screens, batteries, fast chargers & upcoming tools in ' . ($shopSettings['address'] ?? 'Thakurgaon')); ?>
<?php $__env->startSection('meta_keywords', 'M3 Mobile Care, Mobile Store Bangladesh, Phone Parts Shop, iPhone Display Price, Samsung Screen Repair, Mobile Accessories Thakurgaon, Trending Phone Accessories, Upcoming Mobile Repair Tools, FRP Unlock'); ?>
...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-light-glass sticky-top py-3" aria-label="Main Navigation">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('home')); ?>" aria-label="M3 Mobile Care Homepage">
                <img src="<?php echo e(asset('assets/img/branding/logo-light-icon.png')); ?>" alt="M3 Mobile Care Logo" width="40" height="40" style="height: 40px; width: auto; object-fit: contain;" class="me-2.5">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-2">
                        <a class="btn btn-orange-gradient px-4 py-2.5 rounded-pill fw-bold" href="<?php echo e(route('book.form')); ?>"><i class="ti tabler-calendar-plus me-1.5"></i>Book Repair</a>
                    </li>
                </ul>
            </div>
        </div>
...
<main>
            ...
            <div class="row align-items-center gy-5 mb-5">
                ...
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <p class="fs-5 text-slate-600 mb-4 max-w-xl fw-normal" style="line-height: 1.6;">
                        Browse 100% genuine OLED displays, high-health replacement batteries, fast chargers, and premium mobile accessories in <?php echo e($shopSettings['address'] ?? 'Thakurgaon'); ?>. Track your device repair diagnostics live.
                    </p>
                    ...
                    <div class="d-flex flex-wrap gap-3 justify-content-center justify-content-lg-start mb-4">
                        ...
                        <a href="<?php echo e(route('book.form')); ?>" class="btn btn-glass-secondary btn-lg px-4.5 py-3 rounded-pill fw-bold fs-6">
                ...
                <div class="col-lg-6">
                    <div class="hero-img-box">
                        ...
                        <img src="<?php echo e(asset('assets/img/front-pages/hero_showcase.png')); ?>" alt="M3 Mobile Care Lab & Store Showcase" width="600" height="420" class="img-fluid">
                ...
                <div class="col-lg-10">
                    <div class="premium-glass-card p-4 p-md-4.5" style="border-top: 4px solid #f37021 !important;">
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-md-7">
                                <form action="<?php echo e(route('track.search')); ?>" method="POST" class="d-flex flex-column flex-sm-row gap-2">
                                    <?php echo csrf_field(); ?>
                                    <div class="flex-grow-1">
                                        <label for="ticket_id_input" class="visually-hidden">Tracking Ticket ID Code</label>
                                        <input type="text" id="ticket_id_input" name="ticket_id" aria-label="Enter Ticket ID Code" class="form-control form-control-lg input-hero-glow text-center text-sm-start" placeholder="e.g. M3-202608-XXXX" value="<?php echo e(request('ticket_id')); ?>" required style="border-radius: 14px; height: 52px;">
                                    </div>
    ...
    <section id="store-details" class="py-5 section-slate">
        <div class="container py-4">
            <div class="text-center mb-5">
                <span class="badge bg-label-primary mb-2 px-3 py-1.5 fs-7 text-uppercase fw-bold">Welcome to <?php echo e($shopSettings['shop_name'] ?? 'M3 Mobile Care'); ?></span>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="premium-glass-card p-4 h-100">
                        ...
                        <p class="small text-slate-600 mb-0">Visit our store in <?php echo e($shopSettings['address'] ?? 'Ranisankail, Thakurgaon'); ?> to browse genuine accessories, test displays live, or get free device diagnostics.</p>
                    </div>
                </div>
    ...
    <section id="trending" class="py-5 section-white">
        <div class="container py-4">
            ...
            <!-- Product Grid -->
            <div class="row g-4">
                <?php if(isset($inventoryProducts) && count($inventoryProducts) > 0): ?>
                    <?php $__currentLoopData = $inventoryProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-6 col-lg-3">
                        <div class="product-card-premium p-4 position-relative h-100 d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <span class="text-slate-500 small d-block mb-1"><?php echo e($item->brand ?? 'M3 Original'); ?></span>
                                <h3 class="h6 fw-bold text-dark mb-2"><?php echo e($item->name); ?></h3>
                                <p class="small text-slate-600 mb-3"><?php echo e(\Illuminate\Support\Str::limit($item->description ?? 'Genuine replacement part with official warranty', 60)); ?></p>
                            </div>
                            <div>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="fs-5 fw-bold text-success"><?php echo e(number_format($item->sale_price, 0)); ?> BDT</span>
                                    <span class="text-slate-500 small"><i class="ti tabler-box me-1"></i><?php echo e($item->quantity); ?> Qty</span>
                                </div>
                                <a href="<?php echo e(route('book.form', ['model' => $item->name])); ?>" class="btn btn-glass-secondary btn-sm w-100 py-2 rounded-pill fw-bold">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="product-card-premium p-4 position-relative h-100 d-flex flex-column justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('book.form', ['model' => 'iPhone 15 Pro Max Screen'])); ?>" class="btn btn-glass-secondary btn-sm w-100 py-2 rounded-pill fw-bold">
                                    <i class="ti tabler-shopping-cart me-1"></i>Order / Inquire
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="product-card-premium p-4 position-relative h-100 d-flex flex-column justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('book.form', ['model' => 'Samsung S24 Ultra Display'])); ?>" class="btn btn-glass-secondary btn-sm w-100 py-2 rounded-pill fw-bold">
                                    <i class="ti tabler-shopping-cart me-1"></i>Order / Inquire
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="product-card-premium p-4 position-relative h-100 d-flex flex-column justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('book.form', ['model' => 'iPhone Battery Replacement'])); ?>" class="btn btn-glass-secondary btn-sm w-100 py-2 rounded-pill fw-bold">
                                    <i class="ti tabler-shopping-cart me-1"></i>Order / Inquire
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="product-card-premium p-4 position-relative h-100 d-flex flex-column justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="<?php echo e(route('book.form', ['model' => '67W Fast Charger'])); ?>" class="btn btn-glass-secondary btn-sm w-100 py-2 rounded-pill fw-bold">
                                    <i class="ti tabler-shopping-cart me-1"></i>Order / Inquire
                                </a>
                            </div>
                        </div>
            ...
            <div class="row g-4 mb-5">
                <div class="col-6 col-md-3">
                    <div class="premium-glass-card p-4 text-center h-100 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h4 class="fw-extrabold text-dark mb-0 fs-2"><?php echo e($recentRepairs->count()); ?></h4>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="premium-glass-card p-4 text-center h-100 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h4 class="fw-extrabold text-dark mb-0 fs-2"><?php echo e($repairsByStatus['diagnosing'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="premium-glass-card p-4 text-center h-100 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h4 class="fw-extrabold text-dark mb-0 fs-2"><?php echo e($repairsByStatus['repairing'] ?? 0); ?></h4>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="premium-glass-card p-4 text-center h-100 d-flex flex-column align-items-center justify-content-center">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($recent->customer): ?>
                                                    ...
                                                    <span class="text-slate-400 small d-block"><?php echo e(substr($recent->customer->phone, 0, 4)); ?>****<?php echo e(substr($recent->customer->phone, -4)); ?></span>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <span class="fw-semibold text-dark d-flex align-items-center">
                                                    <i class="ti tabler-device-mobile text-slate-400 me-1.5 small"></i><?php echo e($recent->device_brand); ?> <?php echo e($recent->device_model); ?>

                                                </span>
                                            </td>
                                            <td class="small text-slate-600"><?php echo e(\Illuminate\Support\Str::limit($recent->issue_description, 35)); ?></td>
                                            <td>
                                                <?php
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Yes! All OLED displays, batteries, fast chargers, and accessories listed at <?php echo e($shopSettings['shop_name'] ?? 'M3 Mobile Care'); ?> are 100% genuine and pass strict multi-point laboratory quality testing before dispatch.
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content premium-glass-card p-0 border-0">
            <div class="modal-header border-bottom p-4 d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(asset('assets/img/branding/logo-light-icon.png')); ?>" alt="M3 Logo" width="36" height="36" style="height: 36px; width: auto; object-fit: contain;" class="me-3">
                    <div>
                        <h2 class="modal-title h4 fw-bold text-dark mb-0" id="repairDetailsModalLabel">Your Repair Details</h2>
                        <span class="text-slate-600 small">Traced Code: <strong style="color: #f37021 !important;"><?php echo e(request('ticket_id')); ?></strong></span>
                    </div>
                </div>
...
<footer class="bg-white border-top border-slate-200 py-5">
    <div class="container">
        <div class="row g-4 mb-5">
            <div class="col-md-5">
                <div class="d-flex align-items-center mb-3">
                    <img src="<?php echo e(asset('assets/img/branding/logo-light-icon.png')); ?>" alt="M3 Mobile Care Logo" width="36" height="36" class="me-2">
                    <span class="fs-4 fw-bold text-dark"><?php echo e($shopSettings['shop_name'] ?? 'M3 Mobile Care'); ?></span>
                </div>
                <p class="text-slate-600 small mb-3 max-w-sm"><?php echo e($shopSettings['shop_slogan'] ?? 'Premium Mobile Repair & Retail'); ?> — Genuine smartphone parts store & chip-level repair lab.</p>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled small mb-0">
                    <li class="mb-2"><a href="<?php echo e(route('home')); ?>" class="text-slate-600 text-decoration-none hover-text-dark">Home Store</a></li>
                    ...
                    <li class="mb-2"><a href="<?php echo e(route('book.form')); ?>" class="text-slate-600 text-decoration-none hover-text-dark">Book Repair Appointment</a></li>
                    <li class="mb-2"><a href="<?php echo e(url('/sitemap.xml')); ?>" class="text-slate-600 text-decoration-none hover-text-dark" target="_blank">XML Sitemap</a></li>
                </ul>
            </div>
            <div class="col-md-4">
                <h3 class="h6 text-dark fw-bold mb-3 text-uppercase tracking-wider">Store & Contact Details</h3>
                <p class="text-slate-600 small mb-2"><i class="ti tabler-map-pin me-2 text-primary"></i><strong>Address:</strong> <?php echo e($shopSettings['address'] ?? 'Goffar Market, Ranisankail, Thakurgoan'); ?></p>
                <p class="text-slate-600 small mb-2"><i class="ti tabler-phone me-2 text-primary"></i><strong>Phone:</strong> <?php echo e($shopSettings['phone'] ?? '+880 1712-345678'); ?></p>
                <p class="text-slate-600 small mb-2"><i class="ti tabler-mail me-2 text-primary"></i><strong>Email:</strong> <?php echo e($shopSettings['email'] ?? 'info@m3mobilecare.com'); ?></p>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
            <p class="text-slate-500 small mb-0">&copy; <?php echo e(date('Y')); ?> <?php echo e($shopSettings['shop_name'] ?? 'M3 Mobile Care'); ?>. All rights reserved.</p>
            
            <!-- Staff Login Portal Link (Discreetly in Footer) -->
            <div>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary btn-sm rounded-pill px-3 py-1.5 text-slate-600" style="border-color: #cbd5e1; font-size: 0.8rem;">
