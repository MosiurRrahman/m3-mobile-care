...
<?php $__env->startSection('title', 'Edit Job Card - M3 Mobile Care'); ?>
...
<div class="row">
    <div class="col-12 mb-4">
        <h4 class="fw-bold mb-0">Update Job Card: <span class="text-primary"><?php echo e($repair->ticket_id); ?></span></h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.repairs.index')); ?>">Repairs</a></li>
                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.repairs.show', $repair->id)); ?>"><?php echo e($repair->ticket_id); ?></a></li>
    ...
    <div class="col-md-12">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4 p-md-5">
                ...
                <form action="<?php echo e(route('admin.repairs.update', $repair->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <?php if(auth()->user()->isTechnician()): ?>
                        ...
                        <div class="p-3 bg-light rounded-3 mb-4">
                            ...
                            <table class="table table-sm table-borderless mb-0 small">
                                <tr>
                                    ...
                                    <td><?php echo e($repair->customer ? $repair->customer->name : 'Walk-in'); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted fw-semibold">Device Model</td>
                                    <td class="fw-bold text-primary"><?php echo e($repair->device_brand); ?> <?php echo e($repair->device_model); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted fw-semibold">Issue Description</td>
                                    <td><?php echo e($repair->issue_description); ?></td>
                                </tr>
                                <tr>
                                    <td class="text-muted fw-semibold">Unlock Credentials</td>
                                    <td class="text-warning fw-bold"><?php echo e($repair->password_pattern ?? 'None'); ?></td>
                                </tr>
                                <tr>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <select name="status" id="status" class="form-select" required>
                                    <option value="pending" <?php echo e(old('status', $repair->status) == 'pending' ? 'selected' : ''); ?>>Pending confirmation</option>
                                    <option value="diagnosing" <?php echo e(old('status', $repair->status) == 'diagnosing' ? 'selected' : ''); ?>>Diagnosing</option>
                                    <option value="waiting_for_approval" <?php echo e(old('status', $repair->status) == 'waiting_for_approval' ? 'selected' : ''); ?>>Waiting Approval</option>
                                    <option value="repairing" <?php echo e(old('status', $repair->status) == 'repairing' ? 'selected' : ''); ?>>Repairing</option>
                                    <option value="quality_check" <?php echo e(old('status', $repair->status) == 'quality_check' ? 'selected' : ''); ?>>Quality Check</option>
                                    <option value="completed" <?php echo e(old('status', $repair->status) == 'completed' ? 'selected' : ''); ?>>Completed (Ready)</option>
                                    <option value="delivered" <?php echo e(old('status', $repair->status) == 'delivered' ? 'selected' : ''); ?>>Delivered</option>
                                    <option value="cancelled" <?php echo e(old('status', $repair->status) == 'cancelled' ? 'selected' : ''); ?>>Cancelled</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered align-middle mb-0">
                                    ...
                                    <tbody id="parts-container">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $usedParts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $part): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="part-row">
                                                <td>
                                                    <select class="form-select form-select-sm select-part-item mb-1" name="used_parts[<?php echo e($index); ?>][inventory_id]">
                                                        ...
                                                        <?php $__currentLoopData = $inventoryItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>" 
                                                                ...
                                                                <?php echo e(isset($part['inventory_id']) && $part['inventory_id'] == $item->id ? 'selected' : ''); ?>>
                                                                <?php echo e($item->name); ?> (Qty: <?php echo e($item->quantity); ?>, Cost: <?php echo e($item->purchase_price); ?> BDT)
                                                            </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <input type="text" name="used_parts[<?php echo e($index); ?>][name]" class="form-control form-control-sm input-part-name" value="<?php echo e($part['name']); ?>" placeholder="Enter part name manually" required>
                                                </td>
                                                <td>
                                                    <input type="number" name="used_parts[<?php echo e($index); ?>][buying_price]" class="form-control form-control-sm input-buying-price text-end" value="<?php echo e($part['buying_price']); ?>" step="0.01" min="0" required>
                                                </td>
                                                <td>
                                                    <input type="number" name="used_parts[<?php echo e($index); ?>][quantity]" class="form-control form-control-sm input-quantity text-center" value="<?php echo e($part['quantity']); ?>" min="1" required>
                                                </td>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <textarea name="technician_notes" id="technician_notes" rows="4" class="form-control" placeholder="Describe operations done, parts replaced, current condition..." required><?php echo e(old('technician_notes', $repair->technician_notes)); ?></textarea>
                            </div>
                        </div>
                    <?php else: ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <select name="customer_id" id="customer_id" class="form-select" required>
                                    ...
                                    <option value="<?php echo e($customer->id); ?>" <?php echo e(old('customer_id', $repair->customer_id) == $customer->id ? 'selected' : ''); ?>><?php echo e($customer->name); ?> (<?php echo e($customer->phone); ?>)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <input type="text" name="device_brand" id="device_brand" class="form-control" value="<?php echo e(old('device_brand', $repair->device_brand)); ?>" required>
                            </div>
                            <div class="col-md-4 mb-3 mb-md-0">
                                <label class="form-label fw-semibold" for="device_model">Model <span class="text-danger">*</span></label>
                                <input type="text" name="device_model" id="device_model" class="form-control" value="<?php echo e(old('device_model', $repair->device_model)); ?>" required>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold" for="serial_imei">IMEI / Serial Number</label>
                                <input type="text" name="serial_imei" id="serial_imei" class="form-control" value="<?php echo e(old('serial_imei', $repair->serial_imei)); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <input type="text" name="password_pattern" id="password_pattern" class="form-control" value="<?php echo e(old('password_pattern', $repair->password_pattern)); ?>">
                                ...
                                <div id="pattern-lock-wrapper" class="mt-2 card p-2 border" style="display: none; width: fit-content; background: #f8f9fa;">
                                    <div id="pattern-holder" style="width: 180px; height: 180px; position: relative; background: #eef1f6; border-radius: 8px; touch-action: none; overflow: hidden;">
                                        ...
                                        <div style="display: grid; grid-template-columns: repeat(3, 1fr); grid-template-rows: repeat(3, 1fr); height: 100%; width: 100%; padding: 10px; box-sizing: border-box;">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">
                                                <div class="pattern-dot" data-index="<?php echo e($i); ?>" style="width: 14px; height: 14px; border-radius: 50%; background: #a1b0cb; cursor: pointer; z-index: 10; transition: all 0.2s ease;"></div>
                                            </div>
                                            <?php endfor; ?>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mt-2" style="width: 180px;">
                                        <span class="small text-muted" id="pattern-path-label">Path: <?php echo e($repair->pattern_lock_path ?? 'None'); ?></span>
                                    ...
                                    <input type="hidden" name="pattern_lock_path" id="pattern_lock_path" value="<?php echo e(old('pattern_lock_path', $repair->pattern_lock_path)); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <textarea name="issue_description" id="issue_description" rows="3" class="form-control" required><?php echo e(old('issue_description', $repair->issue_description)); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="device_checklist[scratches]" id="chk_scratches" value="yes" <?php echo e(isset($checklist['scratches']) && $checklist['scratches'] == 'yes' ? 'checked' : ''); ?>>
                                            <label class="form-check-label fw-semibold" for="chk_scratches">Body Scratches / Dents</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="device_checklist[display_ok]" id="chk_display" value="yes" <?php echo e(!isset($checklist['display_ok']) || $checklist['display_ok'] == 'yes' ? 'checked' : ''); ?>>
                                            <label class="form-check-label fw-semibold" for="chk_display">Display Functional</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="device_checklist[touch_ok]" id="chk_touch" value="yes" <?php echo e(!isset($checklist['touch_ok']) || $checklist['touch_ok'] == 'yes' ? 'checked' : ''); ?>>
                                            <label class="form-check-label fw-semibold" for="chk_touch">Touch Screen Working</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="device_checklist[camera_ok]" id="chk_camera" value="yes" <?php echo e(!isset($checklist['camera_ok']) || $checklist['camera_ok'] == 'yes' ? 'checked' : ''); ?>>
                                            <label class="form-check-label fw-semibold" for="chk_camera">Cameras Working</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="device_checklist[audio_ok]" id="chk_audio" value="yes" <?php echo e(!isset($checklist['audio_ok']) || $checklist['audio_ok'] == 'yes' ? 'checked' : ''); ?>>
                                            <label class="form-check-label fw-semibold" for="chk_audio">Speakers & Audio Working</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="device_checklist[buttons_ok]" id="chk_buttons" value="yes" <?php echo e(!isset($checklist['buttons_ok']) || $checklist['buttons_ok'] == 'yes' ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if($repair->device_photos && count($repair->device_photos) > 0): ?>
                                    <label class="form-label d-block fw-semibold mb-2 text-muted">Currently Uploaded Photos:</label>
                                    <div class="d-flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $repair->device_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="position-relative rounded overflow-hidden border" style="width: 80px; height: 80px;">
                                                <img src="<?php echo e(asset('storage/' . $photo)); ?>" class="w-100 h-100 object-fit-cover">
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                <?php endif; ?>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <select name="assigned_technician_id" id="assigned_technician_id" class="form-select">
                                    ...
                                    <option value="<?php echo e($tech->id); ?>" <?php echo e(old('assigned_technician_id', $repair->assigned_technician_id) == $tech->id ? 'selected' : ''); ?>><?php echo e($tech->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fw-semibold" for="expected_delivery_date">Expected Delivery Date</label>
                                <input type="date" name="expected_delivery_date" id="expected_delivery_date" class="form-control" value="<?php echo e(old('expected_delivery_date', $repair->expected_delivery_date)); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6 mb-3 mb-md-0">
                                ...
                                <select name="commission_type" id="commission_type" class="form-select">
                                    <option value="" <?php echo e(empty($repair->commission_type) ? 'selected' : ''); ?>>No Commission / Salary-based</option>
                                    <option value="percentage" <?php echo e(old('commission_type', $repair->commission_type) == 'percentage' ? 'selected' : ''); ?>>Percentage (%)</option>
                                    <option value="flat" <?php echo e(old('commission_type', $repair->commission_type) == 'flat' ? 'selected' : ''); ?>>Flat Amount (BDT)</option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" for="commission_rate">Commission Value</label>
                                <input type="number" name="commission_rate" id="commission_rate" step="0.01" min="0" class="form-control" value="<?php echo e(old('commission_rate', $repair->commission_rate)); ?>">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-3 mb-3 mb-md-0">
                                ...
                                <input type="number" name="repair_charge" id="repair_charge" step="0.01" min="0" class="form-control" value="<?php echo e(old('repair_charge', $repair->repair_charge)); ?>">
                            </div>
                            <div class="col-md-3 mb-3 mb-md-0">
                                <label class="form-label fw-semibold" for="estimated_cost">Estimated Cost (BDT)</label>
                                <input type="number" name="estimated_cost" id="estimated_cost" step="0.01" min="0" class="form-control bg-light" value="<?php echo e(old('estimated_cost', $repair->estimated_cost)); ?>" readonly>
                            ...
                            <div class="col-md-3 mb-3 mb-md-0">
                                ...
                                <input type="number" name="advance_payment" id="advance_payment" step="0.01" min="0" class="form-control" value="<?php echo e(old('advance_payment', $repair->advance_payment)); ?>">
                            </div>
                            <div class="col-md-3">
                                ...
                                <select name="advance_payment_method" id="advance_payment_method" class="form-select">
                                    ...
                                    <option value="Cash" <?php echo e(old('advance_payment_method', $repair->advance_payment_method) == 'Cash' ? 'selected' : ''); ?>>Cash</option>
                                    <option value="bKash" <?php echo e(old('advance_payment_method', $repair->advance_payment_method) == 'bKash' ? 'selected' : ''); ?>>bKash</option>
                                    <option value="Nagad" <?php echo e(old('advance_payment_method', $repair->advance_payment_method) == 'Nagad' ? 'selected' : ''); ?>>Nagad</option>
                                    <option value="Rocket" <?php echo e(old('advance_payment_method', $repair->advance_payment_method) == 'Rocket' ? 'selected' : ''); ?>>Rocket</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <input type="number" name="warranty_days" id="warranty_days" min="0" class="form-control" value="<?php echo e(old('warranty_days', $repair->warranty_days ?? 0)); ?>" placeholder="e.g. 90">
                            ...
                            <div class="col-md-8 d-flex align-items-center mt-md-3">
                                <div class="form-check form-switch card p-2 px-3 border w-100 bg-label-warning border-warning d-flex align-items-center flex-row gap-2">
                                    <input class="form-check-input ms-0" type="checkbox" name="data_loss_consent" id="data_loss_consent" value="1" <?php echo e(old('data_loss_consent', $repair->data_loss_consent) ? 'checked' : ''); ?> required>
                                    <div class="ms-2">
                        ...
                        <div class="row mb-4 p-3 bg-light rounded border mx-0">
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="actual_cost" id="actual_cost" step="0.01" min="0" class="form-control fw-bold text-dark" value="<?php echo e(old('actual_cost', $repair->actual_cost)); ?>" placeholder="Fill total bill at delivery">
                                <div class="form-text small text-info mt-1" style="font-size: 0.75rem;">
                                    Counter Due: <strong id="val-final-due">0.00</strong> BDT (excluding <?php echo e(number_format($repair->advance_payment, 2)); ?> BDT advance)
                                </div>
                            </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            ?>
                                            <input type="number" name="cash_delivery" id="cash_delivery" step="0.01" min="0" class="form-control text-end fw-bold text-dark" value="<?php echo e($oldCashDelivery ?? 0); ?>" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            ?>
                                            <input type="number" name="bkash_delivery" id="bkash_delivery" step="0.01" min="0" class="form-control text-end fw-bold text-dark" value="<?php echo e($oldBkashDelivery ?? 0); ?>" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            ?>
                                            <input type="number" name="nagad_delivery" id="nagad_delivery" step="0.01" min="0" class="form-control text-end fw-bold text-dark" value="<?php echo e($oldNagadDelivery ?? 0); ?>" placeholder="0">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group input-group-sm">
                                            ...
                                            ?>
                                            <input type="number" name="rocket_delivery" id="rocket_delivery" step="0.01" min="0" class="form-control text-end fw-bold text-dark" value="<?php echo e($oldRocketDelivery ?? 0); ?>" placeholder="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" id="remaining_due" step="0.01" class="form-control bg-light text-danger fw-bold" value="<?php echo e(old('due_amount', $repair->due_amount)); ?>" readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3" id="cash_received_container" style="display: none;">
                                ...
                                <input type="number" name="cash_received" id="cash_received" step="0.01" min="0" class="form-control text-dark fw-bold" value="<?php echo e(old('cash_received', $repair->cash_received)); ?>">
                            </div>
                            <div class="col-md-3 mb-3" id="change_returned_container" style="display: none;">
                                ...
                                <input type="number" name="change_returned" id="change_returned" step="0.01" min="0" class="form-control bg-light text-success fw-bold" value="<?php echo e(old('change_returned', $repair->change_returned)); ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <textarea name="technician_notes" id="technician_notes" rows="4" class="form-control" placeholder="Write logs, diagnose details, or parts replaced..."><?php echo e(old('technician_notes', $repair->technician_notes)); ?></textarea>
                            </div>
                        </div>
                    <?php endif; ?>

                    <div class="d-flex gap-2 justify-content-end mt-4">
                        <a href="<?php echo e(route('admin.repairs.show', $repair->id)); ?>" class="btn btn-outline-secondary">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const inventoryItems = <?php echo json_encode($inventoryItems, 15, 512) ?>;
    let partIndex = <?php echo e(count($repair->used_parts ?? [])); ?>;
...
<?php echo $__env->make('layouts/contentNavbarLayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\m3-mobile-care\resources\views/repairs/edit.blade.php ENDPATH**/ ?>