...
@section('title', 'Spare Parts Stock - M3 Mobile Care')
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-transparent border-0 py-3">
                <form action="{{ route('admin.inventory.parts') }}" method="GET" class="row g-2 align-items-center">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2 d-flex gap-1.5">
                        ...
                        <a href="{{ route('admin.inventory.parts') }}" class="btn btn-sm btn-outline-secondary w-100">Reset</a>
                    </div>
                </form>
            </div>
