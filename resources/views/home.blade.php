...
@section('title', 'M3 Mobile Care - Live Service Board')
        ...
        <div class="row g-4 mb-5">
            <div class="col-6 col-md-3">
                <div class="glass-card p-4 text-center h-100 hover-scale">
                    ...
                    <h3 class="fw-bold text-white mb-0">{{ $recentRepairs->count() }}</h3>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="glass-card p-4 text-center h-100 hover-scale">
                    ...
                    <h3 class="fw-bold text-white mb-0">{{ $repairsByStatus['diagnosing'] ?? 0 }}</h3>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="glass-card p-4 text-center h-100 hover-scale">
                    ...
                    <h3 class="fw-bold text-white mb-0">{{ $repairsByStatus['repairing'] ?? 0 }}</h3>
                </div>
            </div>
            <div class="col-6 col-md-3">
                <div class="glass-card p-4 text-center h-100 hover-scale">
                                    ...
                                    <tr class="border-bottom border-white border-opacity-5">
                                        ...
                                        <td>
                                            <span class="fw-semibold text-white d-flex align-items-center">
                                                <i class="ti tabler-device-mobile text-muted me-1.5 small"></i>{{ $recent->device_brand }} {{ $recent->device_model }}
                                            </span>
                                        </td>
                                        <td class="small text-slate-400">{{ \Illuminate\Support\Str::limit($recent->issue_description, 35) }}</td>
                                        <td>
                                            @php
        ...
        <div class="modal-content glass-card p-0 border-0" style="background: rgba(13, 19, 33, 0.95); backdrop-filter: blur(25px); border: 1px solid rgba(255, 255, 255, 0.1);">
            <div class="modal-header border-bottom border-white border-opacity-10 p-4 d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('assets/img/branding/logo-dark-icon.png') }}" alt="M3 Logo" style="height: 36px; width: auto; object-fit: contain;" class="me-3">
                    <div>
                        <h4 class="modal-title fw-bold text-white mb-0" id="repairDetailsModalLabel">Your Repair Details</h4>
                        <span class="text-slate-400 small">Traced Code: <strong style="color: #f37021 !important;">{{ request('ticket_id') }}</strong></span>
                    </div>
                </div>
