        ...
        <div class="d-flex gap-2">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-labelledby="exportExpensesDropdown">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.expenses.export.excel', array_merge(request()->query(), ['period' => 'this_week'])) }}">
                            <i class="ti tabler-calendar-week me-2 text-primary"></i>This Week CSV
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.expenses.export.excel', array_merge(request()->query(), ['period' => 'last_week'])) }}">
                            <i class="ti tabler-calendar-time me-2 text-info"></i>Last Week CSV
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.expenses.export.excel', array_merge(request()->query(), ['period' => 'this_month'])) }}">
                            <i class="ti tabler-calendar me-2 text-success"></i>This Month CSV
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.expenses.export.excel', array_merge(request()->query(), ['period' => 'last_month'])) }}">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.expenses.export.excel', request()->query()) }}">
                            <i class="ti tabler-file-spreadsheet me-2 text-success"></i>Current View CSV
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.expenses.export.pdf', request()->query()) }}" target="_blank">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body bg-light border-top border-bottom py-3">
                <form action="{{ route('admin.expenses.index') }}" method="GET" class="row g-2 align-items-center">
                    ...
                    <div class="col-md-2">
                        <input type="month" name="month" class="form-control form-control-sm" value="{{ request('month') }}" title="Pick Any Specific Month">
                    </div>
